...
public class Federate implements Runnable
{
    //----------------------------------------------------------
    //                    STATIC VARIABLES
    //----------------------------------------------------------
    ...
    public Federate(String federateName)
    {
        name = federateName;
    }
    ...
    {
        System.out.println( "TramFederate   : " + message );
    }
    ...
    public void runFederate() throws RTIexception
    {
        ...
        try
        {
            ...
            rtiamb.createFederationExecution( "TramPassing",
                    fom.toURI().toURL() );
        ...
        rtiamb.joinFederationExecution( name, "TramPassing", fedamb );
